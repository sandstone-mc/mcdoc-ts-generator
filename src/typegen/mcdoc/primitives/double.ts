...
export function non_integral_generic<TYPE extends string, JS_NUMBER_ALLOWED extends (true | undefined)>(
  range: mcdoc.NumericRange,
  type: TYPE,
  allow_js_number?: JS_NUMBER_ALLOWED,
) {
