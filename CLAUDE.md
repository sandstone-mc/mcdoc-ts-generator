...
Generated types have **11 errors** when type-checked with `bun tsc --noEmit -p types/tsconfig.json`.
...
**1. TS2538 (4 remaining) - Invalid index types in mapped type pattern**
